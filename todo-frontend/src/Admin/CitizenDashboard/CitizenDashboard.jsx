...
function CitizenDashboard() {
  ...
  const initialPage =
    location?.state?.show === "complaints" ? "complaints" : "home";
  const [page, setPage] = useState(initialPage); // keep internal for MyComplaints fallback
  const userName = "User"; // later from login
        ...
        <div className="dashboard-container">
          ...
          <div className="trust-message">
            ...
            <p className="trust-desc">
              We are here to listen and act. Every complaint you file is
              important and deserves attention. Our system is designed with your
              trust in mind—your information is secure, your concerns are
              confidential, and your grievances are handled with care by
              dedicated officials. From the moment you submit, you can track
              every step of your complaint's progress. We don't just register
              complaints; we work towards real solutions. Your feedback helps us
